...
9. Lag én eller flere løsningsforslag. Det kan være en god idé å lage løsninger som er for trege eller feil. Skriv `@EXPECTED_RESULTS@: CORRECT` som en kommentar øverst i løsningskoden. Bytt  `CORRECT` med `TIMELIMIT`, `WRONG-ANSWER` eller `RUN-ERROR` etter hva som passer. Dette brukes til automatisk testing.
...
__Status__: Ferdig, og godkjent av Håkon og Martin
